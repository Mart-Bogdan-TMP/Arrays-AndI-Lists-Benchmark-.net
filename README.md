...
InlineSize  : Generic : Array      182,993     47,801 31,617 ms/op
InlineSize  : Generic : List       185,356     37,980 25,121 ms/op
InlineSize  : NonGen  : Array      175,120     29,301 19,380 ms/op
InlineSize  : NonGen  : List       170,942     29,498 19,511 ms/op
InlineSize  : Exact   : Array       62,975     24,662 16,312 ms/op
InlineSize  : Exact   : List       136,844     32,367 21,409 ms/op
...
InlineSize  : Generic : Array      110,840     19,507 12,902 ms/op
InlineSize  : Generic : List       119,872     39,026 25,814 ms/op
InlineSize  : NonGen  : Array      108,968     32,408 21,436 ms/op
InlineSize  : NonGen  : List       125,409     33,665 22,268 ms/op
InlineSize  : Exact   : Array       10,721      1,230  0,814 ms/op
InlineSize  : Exact   : List        22,129      3,501  2,315 ms/op
